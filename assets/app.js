...
function V1Hero() {
  ...
  }, "Incredible Platform is an upcoming talent competition app for creators, fans, and event partners. We are building the first beta now: join the waitlist for early access, pilot updates, and launch invites."), React.createElement(V1WaitlistForm, null), React.createElement("div", {
    style: {
      display: 'flex',
      flexWrap: 'wrap',
      gap: isMobile ? 22 : 36,
...
function V1Prize() {
  ...
  return React.createElement("section", {
  ...
  }, "Join the waitlist for beta invites, pilot city updates, creator onboarding, and launch rewards as Incredible Platform gets closer to release."), React.createElement("div", {
    style: {
      display: 'flex',
      gap: 14,
      marginTop: 30
    ...
    onClick: () => openJoinModal({
      ...
      subtitle: 'Verify your mobile number to join the Incredible Platform early access list.'
    }),
    style: {
      background: '#1A1A1A',
      color: '#fff'
...
function V1Partners() {
  ...
  }, "Incredible Platform is preparing tools for voting, moderation, audience analytics, sponsor visibility, and creator operations. Partner access will open as the beta becomes ready for pilot events."), React.createElement("div", {
    style: {
      display: 'grid',
...
function V1FAQ() {
  ...
  const qs = [{
    ...
    a: 'Not yet. Incredible Platform is under development, and this landing page is collecting verified early access requests before the first beta opens.'
  }, {
...
function V1Footer() {
  ...
  }, "Incredible Platform is an upcoming talent competition app for creators, fans, and event partners. Join the waitlist while the beta is being built."), React.createElement("div", {
    style: {
      display: 'flex',
      gap: 8
    }
